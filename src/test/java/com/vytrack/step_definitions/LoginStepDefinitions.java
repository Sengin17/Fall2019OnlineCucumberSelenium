...
public class LoginStepDefinitions {
    ...
    public void user_logs_in_as(String role) {
        ...
        // Login page e yeni bir parametre alan login overloading method yazdik rol icin
...
Cucumber goes into steps andthen goes to step definitions looks for matching setps.
